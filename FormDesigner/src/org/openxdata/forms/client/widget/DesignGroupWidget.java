...
import org.openxdata.forms.client.view.DesignGroupView;
...
public class DesignGroupWidget extends DesignGroupView implements DragDropListener{
	...
	private DesignWidgetWrapper addNewPicture(){
		...
		DOM.setStyleAttribute(image.getElement(), "height","150"+OpenXdataConstants.UNITS);
	...
	/**
	 * @see org.openxdata.forms.client.controller.DragDropListener#onDrop(Widget, int, int)
	 */
