...
public class WidgetPropertiesView extends Composite implements WidgetSelectionListener, IFormSelectionListener{
		...
		txtFontSize.addChangeHandler(new ChangeHandler(){
			public void onChange(ChangeEvent event){
				if(widget != null)
					...
					widgetPropertyChangeListener.onWidgetPropertyChanged(WidgetPropertySetter.PROP_FONT_SIZE, txtFontSize.getText()+OpenXdataConstants.UNITS);
			}
		});
	...
	private void updateWidth(){
		if(txtWidth.getText().trim().length() > 0){
			if(widget != null)		
				widget.setWidth(txtWidth.getText()+OpenXdataConstants.UNITS);
			else if(viewWidget != null){
				if(viewWidget instanceof DesignSurfaceView)
					((DesignSurfaceView)viewWidget).setWidth(txtWidth.getText()+OpenXdataConstants.UNITS);
				else
					viewWidget.setWidth(txtWidth.getText()+OpenXdataConstants.UNITS);
			}
			else
				widgetPropertyChangeListener.onWidgetPropertyChanged(WidgetPropertySetter.PROP_WIDTH, txtWidth.getText()+OpenXdataConstants.UNITS);
		}
	}
	...
	private void updateHeight(){
		if(txtHeight.getText().trim().length() > 0){
			if(widget != null)
				widget.setHeight(txtHeight.getText()+OpenXdataConstants.UNITS);
			else if(viewWidget != null){
				if(viewWidget instanceof DesignSurfaceView)
					((DesignSurfaceView)viewWidget).setHeight(txtHeight.getText()+OpenXdataConstants.UNITS);
				else
					viewWidget.setHeight(txtHeight.getText()+OpenXdataConstants.UNITS);
			}
			else
				widgetPropertyChangeListener.onWidgetPropertyChanged(WidgetPropertySetter.PROP_HEIGHT, txtHeight.getText()+OpenXdataConstants.UNITS);
		}
	}
	...
	private void updateLeft(){
		if(txtLeft.getText().trim().length() > 0){
			if(widget != null)
				widget.setLeft(txtLeft.getText()+OpenXdataConstants.UNITS);
			else
				widgetPropertyChangeListener.onWidgetPropertyChanged(WidgetPropertySetter.PROP_LEFT, txtLeft.getText()+OpenXdataConstants.UNITS);
		}
	}
	...
	private void updateTop(){
		if(txtTop.getText().trim().length() > 0){
			if(widget != null)
				widget.setTop(txtTop.getText()+OpenXdataConstants.UNITS);
			else
				widgetPropertyChangeListener.onWidgetPropertyChanged(WidgetPropertySetter.PROP_TOP, txtTop.getText()+OpenXdataConstants.UNITS);
		}
	}
	...
	/**
	 * @see org.openxdata.forms.client.controller.WidgetSelectionListener#onWidgetSelected(Widget, boolean)
	 */
	...
	/**
	 * @see org.openxdata.forms.client.controller.IFormSelectionListener#onFormItemSelected(Object)
	 */
