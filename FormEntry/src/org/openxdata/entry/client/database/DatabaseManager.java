package org.openxdata.entry.client.database;
...
public class DatabaseManager {
	...
	public native void init() /*-{
		...
		$wnd.dataStore = new $wnd.Persist.Store('OpenXdata Data Store');
	}-*/;
	...
	private native void loadData(String key, DatabaseManager x) /*-{
		$wnd.dataStore.get(key, function(ok, data) {
      			x.@org.openxdata.entry.client.database.DatabaseManager::onDataReceived(ZLjava/lang/String;)(ok,data);
    		});
	}-*/;
