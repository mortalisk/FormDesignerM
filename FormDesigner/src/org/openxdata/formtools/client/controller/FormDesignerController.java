...
import org.openxdata.formtools.client.AboutDialog;
...
public class FormDesignerController implements IFormDesignerListener, OpenFileDialogEventListener{
	...
	/**
	 * @see org.openxdata.formtools.client.controller.IFormActionListener#newForm()
	 */
	public void newForm() {
		if(isOfflineMode())
	...
	/**
	 * @see org.openxdata.formtools.client.controller.IFormActionListener#showAboutInfo()
	 */
			...
			public void execute() {
				try{
					...
					if(!isOfflineMode() && formSaveListener == null)
						saveForm(xml,centerPanel.getLayoutXml(),OpenXdataFormBuilder.getCombinedLanguageText(Context.getLanguageText().get(formDef.getId())),centerPanel.getJavaScriptSource());
	...
	/**
	 * @see org.openxdata.formtools.client.controller.IFormActionListener#moveUp()
	 */
	public void moveUp(){
	...
	/**
	 * @see org.openxdata.formtools.client.controller.IFormActionListener#moveDown()
	 */
	...
	/**
	 * @see org.openxdata.formtools.client.controller.IFormActionListener#moveToParent()
	 */
	...
	/**
	 * @see org.openxdata.formtools.client.controller.IFormActionListener#moveToChild()
	 */
	...
	/**
	 * @see org.openxdata.formtools.client.controller.IFormDesignerListener#openLanguageText()
	 */
	...
	public void saveTheLanguageText(boolean selTab, boolean rebuild){
		try{
			...
			if(isOfflineMode()){
				...
				saveLocaleText(OpenXdataFormBuilder.getCombinedLanguageText(Context.getLanguageText().get(formDef.getId())));
		}
		catch(Exception ex){
			FormUtil.displayException(ex);
		}	
