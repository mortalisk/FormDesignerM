package org.openxdata.forms.client.database;
...
public class DatabaseManager {
	...
	public native void init() /*-{
		...
		$wnd.dataStore = new $wnd.Persist.Store('OpenXdataForms Data Store');
	}-*/;
	...
	private native void loadData(String key, DatabaseManager x) /*-{
		$wnd.dataStore.get(key, function(ok, data) {
      			x.@org.openxdata.forms.client.database.DatabaseManager::onDataReceived(ZLjava/lang/String;)(ok,data);
    		});
	}-*/;
