...
public class FormDesignerEntryPoint implements EntryPoint ,ResizeHandler{
	...
	public void onModuleLoadDeffered() {
		...
		try{
			RootPanel rootPanel = RootPanel.get("openxdataformsdesigner");
			if(rootPanel == null){
				FormUtil.dlg.hide();
				return;
			}
	...
	private native void publishJS() /*-{
   		$wnd.authenticationCallback = @org.openxdata.forms.client.controller.FormDesignerController::authenticationCallback(Z);
   		$wnd.submitForm = @org.openxdata.forms.client.view.FormRunnerView::submitForm();
	}-*/;
